...
#The server will restart and then you should be running SveilOS from memory.
$SSHSOS reboot
...
# TODO: don't use dev, use LABEL - if&when we switch to running this on SveilOS
...
#Reboot and then SveilOS should be fully installed.
#$SSHSOS reboot
